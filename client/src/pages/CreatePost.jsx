                      ...
                      <div className="max-w-[300px] mt-2">
                        ...
                        <input
                          ...
                          {...register("builtyear", {
                            ...
                            validate: {
                              notFutureYear: value => 
                                value <= new Date().getFullYear()+57 || "Built year cannot be in the future*"
                            }
                          })}
                        />
                        {errors.builtyear && (
                  ...
                  <div>
                    ...
                    <div className=" mt-1">
                      <div className="pricing_info flex flex-col">
                        ...
                        <span className="text-sm font-content text-red-900">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex justify-center mt-7">
                        <button
                          ...
                          type="submit"
                          className="w-full max-w-md bg-blue-600 text-xl tracking-wide font-semibold rounded-lg shadow-md hover:bg-blue-700 disabled:opacity-70 transition-colors duration-300 text-white mt-[-22px] py-3 px-5"
                        >
